 ...
 * @class describe 用户永久拒绝权限 引导用户去设置页面
 * @time 2020/5/21 5:34 PM
 * @change
 * @chang time
 * @class describe
 */
public class PermissionUtilSetting {
    ...
    private static final  int  PERMISSION_SETTING_FOR_RESULT =0;
    /**
...
//                    activity.startActivityForResult(getAppDetailSettingIntent(activity), PERMISSION_SETTING_FOR_RESULT);
    ...
    public static void Huawei(Activity activity) {
        try {
            ...
            intent.putExtra("packageName", "com.lw.linwear");
